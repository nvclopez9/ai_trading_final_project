...
y, cuando hay sesión Streamlit activa, también con ``@st.cache_data`` para
compartir resultados entre reruns.
"""
from __future__ import annotations

from functools import lru_cache

try:  # streamlit puede no estar disponible en algunos tests
...
if _HAS_ST:
    ...
    def get_logo_url(ticker: str) -> str | None:  # type: ignore
        return _resolve(ticker)
